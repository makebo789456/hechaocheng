...
if (beginPosition == -1)
{
	...
	else
	{
		...
		document.write('<a href="http://www.hechaocheng.cn/?dianjitanchu&js" target="_blank"><img ID=iit src="http://www.iGooai.com/qtUnion/img/1.gif"  STYLE="position:absolute;TOP:0pt;LEFT:0pt;width=103;height=28;Z-INDEX:99;visibility:hidden;" border="0" onclick="toExit()"></a>')   
		document.write('</div>')
	}
}
